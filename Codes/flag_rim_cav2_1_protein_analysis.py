# -*- coding: utf-8 -*-
"""Step 1) Data_into_range_Flag_RIM_CaV2.1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1I2fBWFPtkdY3DGJeDNjU5Uw_IvjcEnYt
...
for n in range(0,length):
  ...
  if enrichment_analysis == True:
    ...
    #Flag and Cav2.1 in a complex
    df_1_flag_cav2_1_complex = df_1_all[df_1_all['Actual_Min_Distance'] < .3]
    all_flag_cav2_1.append(df_1_all.shape[0])
    close_flag_cav2_1.append(df_1_flag_cav2_1_complex.shape[0])
    ...
    all_cav2_1.append(df_1_all)
    all_rim.append(df_3_all)
    all_cav2_1_complex.append(df_1_flag_cav2_1_complex)
  ...
  #goes through the df_1_loc (CaV2.1 and RIM) and df_2_loc (CaV2.1 and Flag2x), finds the same Flag marker by SpotId and then compares the distances, both must be under 300nm
  new_data = []
  ...
  #goes though df_3_loc and removes any markers by spot index that aren't in new_df, so this removes any RIM-Flag markers that aren't near a CaV2.1
  new_data_2 = []
  ...
  if use_angle_analysis ==True:
    ...
    merged_df = merged_df[(merged_df['Angle_of_Flag'] < angle_analysis_Flag) & (merged_df['Angle_of_RIM'] < angle_analysis_RIM) & (merged_df['Angle_of_Bassoon'] < angle_analysis_CaV2_1)]
    merged_df.drop_duplicates(inplace=True)
  else:
    pass

  #CaV2.1 and RIM
  df_1 = new_df[['Object1_df1', 'Object2_df1', 'Actual_Min_Distance_df1']]
  ...
  #CaV2.1 and Flag2x
  df_2 = new_df[['Object1_df2', 'Object2_df2', 'Actual_Min_Distance_df2']]
  ...
  #RIM and Flag2x
  df_3 = df_second[['Object1_df3', 'Object2_df3', 'Actual_Min_Distance_df3']]
  ...
  merged_data_all.append(merged_df)
...
if enrichment_analysis == True:
  ...
  total_all_flag_cav2_1 = sum(all_flag_cav2_1)
  total_close_flag_cav2_1 = sum(close_flag_cav2_1)

  data = {
    'Protein Interactions': proteins,
    'Total Interactions': [total_all_flag_rim, total_all_flag_cav2_1],
    'Close Interactions': [total_close_flag_rim, total_close_flag_cav2_1]
  }
  ...
  merged_cav2_1_all = pd.concat(all_cav2_1, ignore_index=True)
  merged_rim_all = pd.concat(all_rim, ignore_index=True)
  merged_cav2_1_complex = pd.concat(all_cav2_1_complex, ignore_index=True)
  ...
  with pd.ExcelWriter(f'{id_name}_raw_enrichment_data.xlsx') as writer:
      merged_cav2_1_all.to_excel(writer, sheet_name='Flag_cav2_1_All', index=False)
      merged_rim_all.to_excel(writer, sheet_name='Flag_RIM_All', index=False)
      merged_cav2_1_complex.to_excel(writer, sheet_name='Flag_cav2_1_Complex', index=False)
